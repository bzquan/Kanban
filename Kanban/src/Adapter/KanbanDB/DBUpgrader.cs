...
public class DBUpgrader
{
    ...
    public DBUpgrader(DBVersion dbVersion, IDBCard dbCards)
    {
    ...
    private int DefaultStoryPoints(EstimatedWorkEffort estimatedWorkEffort) =>
        estimatedWorkEffort switch
        {
            EstimatedWorkEffort.Small => 2,
            EstimatedWorkEffort.Medium => 5,
            EstimatedWorkEffort.Large => 8,
            EstimatedWorkEffort.LargeExtra => 13,
            _ => Card.UNKNOWN_STORY_POINTS, // Unknown
        };
