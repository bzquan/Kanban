...
namespace DragAndDropLib
{
    public static class Helper
    {
        ...
        public static bool IsItemControlOrientationHorizontal(ItemsControl itemsControl)
        {
            ...
            string tag = itemsControl.Tag as string;
            if ((tag != null) && (tag == "InsertAdornerHorizontal"))
                return false;
        ...
        public static bool? IsMousePointerOnControl(ItemsControl itemsControl, Point pt)
        {
            return IsMousePointerAtTop(itemsControl, pt) ?? IsMousePointerAtLeft(itemsControl, pt);
        }
        ...
        public static bool? IsMousePointerAtLeft(ItemsControl itemsControl, Point pt)
        {
            if (pt.X > 0.0 && pt.X < 25)
            {
                return true;
            }
            else if (pt.X > itemsControl.ActualWidth - 25 && pt.X < itemsControl.ActualWidth)
            {
                return false;
            }
            return null;
